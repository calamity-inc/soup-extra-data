(module
	...
	(data (i32.const 102) "servihosting")
	(data (i32.const 115) "layer")
	(data (i32.const 121) "server")
	(data (i32.const 128) "vps")
	(data (i32.const 132) "hetzner")
	(data (i32.const 140) "ovh")
	(data (i32.const 144) "contabo")
	(data (i32.const 152) "digitalocean")
	(data (i32.const 165) "amazon")
	(data (i32.const 172) "google llc")
	(data (i32.const 183) "google, llc")
	(data (i32.const 195) "akamai")
	(data (i32.const 202) "microsoft")
	(data (i32.const 212) "alibaba")
	(data (i32.const 220) "fastly")
	(data (i32.const 227) "linode")
	(data (i32.const 234) "aruba")
	(data (i32.const 240) "godaddy")
	(data (i32.const 248) "oracle")
	(data (i32.const 255) "m247")
	(data (i32.const 260) "leaseweb")
	(data (i32.const 269) "ipxo")
	(data (i32.const 274) "proton ag")
	...
	(func (export "is_hosting_slug") (param $slug i32) (result i32)
		...
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 88)))) ;; AS45382 EHOSTICT, AS51430 AltusHost B.V., AS55720 Gigabit Hosting Sdn Bhd, AS61493 InterBS S.R.L. (BAEHOST), AS64200 VIVID-HOSTING LLC, AS136557 Host Universal Pty Ltd, AS200698 Globalhost d.o.o., AS203020 HostRoyale Technologies Pvt Ltd
			...
			(i32.and (i32.eqz (call $blume.strstr (local.get $slug) (i32.const 102)))) ;; https://ipinfo.io/AS29119
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 115)))) ;; AS49453, AS57172 Global Layer B.V.
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 121))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 128))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 132))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 140))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 144))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 152))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 165))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 172)))) ;; added LLC to prevent detection of "Google Fiber Inc"
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 183)))) ;; Google One VPN
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 195))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 202))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 212))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 220))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 227))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 234))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 240))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 248))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 255))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 260))))
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 269)))) ;; AS61317, AS206092
		(i32.or (i32.ne (i32.const 0) (call $blume.strstr (local.get $slug) (i32.const 274))))
		)
	)